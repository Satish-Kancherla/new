...
"[project]/src/app/api/medical-records/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        const record = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].medicalRecord.findUnique({
            where: {
                id
            }
        });
...
async function PUT(request, { params }) {
    ...
    try {
        const updatedRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].medicalRecord.update({
            where: {
                id
            },
            data: body
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedRecord);
    } catch (error) {
...
async function DELETE(request, { params }) {
    const id = (await params).id;
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].medicalRecord.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__06bfc7._.js.map