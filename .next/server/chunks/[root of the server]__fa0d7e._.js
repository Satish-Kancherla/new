...
"[project]/src/app/api/medical-records/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        const records = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].medicalRecord.findMany({
            where: patientId ? {
                patientId: {
                    contains: patientId
                }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(records);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const lastRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].medicalRecord.findFirst({
            orderBy: {
                patientId: "desc"
            }
        });
        ...
        const newRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].medicalRecord.create({
            data: {
                ...body,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newRecord, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__fa0d7e._.js.map